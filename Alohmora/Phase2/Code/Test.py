...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/abhishek/CMSC733/akathpal_hw0/Phase2/Checkpoints/19a400model.ckpt', help='Path to load latest model from, Default:ModelPath')
    Parser.add_argument('--BasePath', dest='BasePath', default='/home/abhishek/CMSC733/akathpal_hw0/Phase2/CIFAR10/Test/', help='Path to load images from, Default:BasePath')
