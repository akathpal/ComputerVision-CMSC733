...
flags.DEFINE_float("explain_reg_weight", 0.5, "Weight for explanability regularization")
flags.DEFINE_float("ssim_weight", 0.7, "Weight for SSIM loss")
flags.DEFINE_integer("batch_size", 8, "The size of of a sample batch")
flags.DEFINE_integer("img_height", 128, "Image height")
flags.DEFINE_integer("step_lr", 20000, "Steps to update learning rate")
...
flags.DEFINE_integer("summary_freq", 10000, "Logging every log_freq iterations")
