...
def GenerateBatch(BasePath, DirNamesTrain, TrainLabels, ImageSize, MiniBatchSize,ModelType):
	...
	if (ModelType.lower() == 'supervised'):
		...
		while ImageNum < MiniBatchSize:
			...
			# imgData=(imgData-np.mean(imgData))/255
		...
		while ImageNum < MiniBatchSize:
			...
			# Append All Images and Mask
			I1FullBatch.append(img)
			PatchBatch.append(imgData)
			CornerBatch.append(src)
			I2Batch.append(patch2.reshape(128,128,1))
...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
	...
	if ModelType.lower() == 'supervised':
		...
		# print(ImageSize)
		pred_I2,I2 = Unsupervised_HomographyModel(ImgPH, CornerPH, I2PH, I1FullPH, ImageSize, MiniBatchSize)
...
def main():
    ...
    TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, 20000, ImageSize,
                   NumEpochs, MiniBatchSize, SaveCheckPoint, CheckPointPath,
                   DivTrain, LatestFile, BasePath, LogsPath, ModelType)
